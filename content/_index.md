...
<!-- /abstract -->
<!-- Features -->
<div class="relative mt-20 w-screen max-w-[1600px] px-[30px] py-16 mb-20 rounded-xl dark:text-neutral-50" style="left: calc(max(-50vw,-800px) + 50%);">
  <section>
...
{{< rawhtml >}}
<!-- FAQ -->
<div class="relative mt-20 w-screen max-w-[1600px] px-[30px] py-16 mb-16 rounded-xl dark:text-neutral-50" style="left: calc(max(-50vw,-800px) + 50%);">
  <section>
<div class="mx-auto text-center mb-10 lg:mb-14">
...
<p class="text-xl text-muted">
  About inner voice, sensation and intuititon
</p>
</div>
...
<div class="grid sm:grid-cols-2 gap-6 md:gap-12">
  ...
  <div class="flex">
    ...
    <div>
      <p class="mb-4 text-xl font-bold">
        How do I distinguish between my inner voice and other thoughts?      
      </p>
      <p class="mb-1 text-neutral-500 dark:text-neutral-300">
        The inner voice usually feels calm, clear, and aligned with your values. Anxious thoughts are often loud, repetitive, and fear-based. Try asking yourself if the feeling brings you peace or worry. Pay attention to physical sensations - warmth, lightness, or expansion often indicate an inner voice, while tightness, heaviness, or constriction might be anxiety.
    </div>
  </div>
  <div class="flex">
    <div class="mr-2">
  ...
  <div class="flex">
    ...
    <div>
      <p class="mb-4 text-xl font-bold">
        Meaning of butterflies in my stomach or a tightness in my chest?
      </p>
      <p class="mb-1 text-neutral-500 dark:text-neutral-300">
        Pay attention to the timing and context of these sensations. Butterflies before a job interview might be excitement, while a tight chest during a conversation could signal discomfort. Trust your body's wisdom and use it to inform your decisions.
      </p>
    </div>
  </div>
  <div class="flex">
    ...
    <div>
      <p class="mb-4 text-xl font-bold">
        Doesn't listening to my inner voice sound whimsical?
      </p>
      <p class="mb-1 text-neutral-500 dark:text-neutral-300">
        Intuition and practicality can go hand-in-hand. Your inner voice can help you navigate through the realities of life while staying true to your values and aspirations. Don't be afraid to blend both approaches for a balanced and fulfilling life.
      </p>
    </div>
  </div>
</div>
...
<div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 text-center justify-center items-center">
  ...
  <div class="md:mb-0 rounded-xl border border-neutral-200 dark:border-neutral-700 py-6 px-6 shadow-2xl text-center">
    <div class="flex justify-center items-center">
   <svg width="64px" height="64px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="#672768" stroke="#672768"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path fill="#852978" d="M312.094 21.97l59.094 119.686h52.093L362.595 22l-50.5-.03zM173 22.687l-63.594 127.218 65.844 345.75 114.688.094L354.467 150 291.626 22.75 173 22.687zm16.063 76.28h88.78v18.688h-88.78V98.97zm0 36.22h88.78v18.687h-88.78v-18.688zm182.5 25.156L309 495.438l47.25.03 68.313-335.124h-53z"></path></g></svg>
    </div>
    <p class="mb-4 mt-4 text-xl font-bold">POHŘEBNÍ ANEKDOTY</p>
    <p class="text-neutral-500 dark:text-neutral-300">
  ...
  <div class="md:mb-0 rounded-xl border border-neutral-200 dark:border-neutral-700 py-6 px-6 shadow-2xl text-center">
    <div class="flex justify-center items-center">
    <svg width="64px" height="64px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.21600000000000003"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M20.58 19.37L17.59 11.01C17.38 10.46 16.91 10.12 16.37 10.12C15.83 10.12 15.37 10.46 15.14 11.03L12.16 19.37C12.02 19.76 12.22 20.19 12.61 20.33C13 20.47 13.43 20.27 13.57 19.88L14.19 18.15H18.54L19.16 19.88C19.27 20.19 19.56 20.38 19.87 20.38C19.95 20.38 20.04 20.37 20.12 20.34C20.51 20.2 20.71 19.77 20.57 19.38L20.58 19.37ZM14.74 16.64L16.38 12.05L18.02 16.64H14.74ZM12.19 7.85C9.92999 11.42 7.89 13.58 5.41 15.02C5.29 15.09 5.16 15.12 5.04 15.12C4.78 15.12 4.53 14.99 4.39 14.75C4.18 14.39 4.3 13.93 4.66 13.73C6.75999 12.51 8.48 10.76 10.41 7.86H4.12C3.71 7.86 3.37 7.52 3.37 7.11C3.37 6.7 3.71 6.36 4.12 6.36H7.87V4.38C7.87 3.97 8.21 3.63 8.62 3.63C9.02999 3.63 9.37 3.97 9.37 4.38V6.36H13.12C13.53 6.36 13.87 6.7 13.87 7.11C13.87 7.52 13.53 7.86 13.12 7.86H12.18L12.19 7.85ZM12.23 15.12C12.1 15.12 11.97 15.09 11.85 15.02C11.2 14.64 10.57 14.22 9.97999 13.78C9.64999 13.53 9.58 13.06 9.83 12.73C10.08 12.4 10.55 12.33 10.88 12.58C11.42 12.99 12.01 13.37 12.61 13.72C12.97 13.93 13.09 14.39 12.88 14.75C12.74 14.99 12.49 15.12 12.23 15.12Z" fill="#3d48e1"></path> </g></svg>
    </div>
...
<div class="grid max-w-6xl mx-auto gap-6 md:grid-cols-3 lg:gap-12">
  <div class="flex h-auto">
        <div class="flex flex-col bg-neutral dark:bg-neutral-900 rounded-xl shadow-2xl">
          ...
          <div class="p-4 bg-wit rounded-b-lg md:px-7">
            <div class="flex items-center">
              ...
              <div class="grow ms-3">
                ...
                <p class="text-xs text-primary-900 dark:text-primary-900">
                  Psychologist
                </p>
              </div>
            </div>
...
<!-- Testimonies People -->
<!-- Stats -->
<div class="relative w-screen max-w-[1600px] px-[30px] mt-6 mb-16" style="left: calc(max(-50vw,-800px) + 50%);">
...
data: {
  ...
  datasets: [{
    label: 'Review of what I have done',
    data: [13, 87, 87, 97],
    backgroundColor: [
...
<!-- Contact -->
<section>
  <div class="relative mt-20 w-screen max-w-[1600px] px-[30px] rounded-xl dark:text-neutral-50" style="left: calc(max(-50vw,-800px) + 50%);">
    <div class="max-w-6xl mx-auto text-center">
      <div class="mx-auto text-center mb-6 lg:mb-14">
...
<div class="max-w-[85rem] rounded-xl">
  <div class="max-w-2xl lg:max-w-5xl mx-auto mt-20">
    <div class="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
      <div class="flex flex-col rounded-xl p-4 shadow-2xl">
        <p class="mb-8 text-xl font-semibold text-gray-800 dark:text-gray-200">
          Fill in the form
        </p>
          ...
          <div class="grid gap-4">
            <!-- Grid -->
              <div>
                ...
                <input type="text" name="name" id="name" class="py-3 px-4 block w-full border-neutral-200 text-primary-900 bg-neutral-50 dark:border-neutral-700 rounded-lg text-sm focus:border-primary-500 form-input" placeholder="Name" type="text">
              </div>
            <div>
              <label for="hs-email-contacts-1 email" class="sr-only form-label">Email</label>
              <input type="email" name="hs-email-contacts-1 email" id="hs-email-contacts-1 email" autocomplete="email" class="y-3 px-4 block w-full border-neutral-200 dark:border-neutral-700 rounded-lg text-sm  text-primary-900 bg-neutral-50 focus:border-primary-500 form-input" placeholder="Email" type="email">
            </div>
            <div>
              <label for="hs-about-contacts-1 message" class="sr-only from-label">Message</label>
              <textarea id="hs-about-contacts-1 message" name="hs-about-contacts-1 message" rows="4" class="y-3 px-4 block w-full border-neutral-200 dark:border-neutral-700 rounded-lg text-sm focus:border-primary-500 form-input  text-primary-900 bg-neutral-50" placeholder="Message goes here"></textarea>
            </div>
          </div>
          <!-- End Grid -->
          <div class="mt-4 grid">
    ...
    <div>
      <p class="font-bold">Sitemap</p>
         <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-300">
           I have designed blueprint of what it's important and and I need to give it time and attention with smile on my face and tools in my pocket. Tags, Categories.
         </p>
