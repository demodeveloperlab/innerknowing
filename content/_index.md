  ...
  <div class="max-w-[85rem] px-6 text-center md:px-12">
    <div class="mx-auto">
      <div class="grid items-center gap-12 lg:grid-cols-2 mb-20">
        <div class="lg:mt-0">
          <h1 class="mb-20 connect font-extrabold display tracking-tight">
            CONNECT
          </h1>
          ...
          <p class="mt-8 mx-auto mb-10 max-lg">
     ...
     <div class="flex items-center justify-center text-primary-900 dark:text-primary-200 font-semibold border py-6 px-8 rounded-full shadow-2xl">
        <p class="text-xl">
           ...
           <svg width="1.5em" height="1.5em" viewBox="0 0 24 24" class="w-6 h-6 inline-block align-text-bottom mr-2" data-icon="tabler:info-square">  <symbol id="ai:tabler:info-square"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 9h.01M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><path d="M11 12h1v4h1"></path></g></symbol> <use xlink:href="#ai:tabler:info-square"></use> </svg>
            PHILOSOPHY KISS:</span> KEEP IT SIMPLE, STUPID!
        </p>
      </div>
    </div>
  </div>
...
{{< rawhtml >}}
  <div class="mt-10 flex justify-center">
  <a href="https://demodeveloperlab.github.io/innerknowing/en/posts/" title="Recent posts" class="bg-transparent hover:text-primary-900 dark:text-primary-200 prose dark:prose-invert font-semibold hover:text-white py-2 px-4 border border-primary-900 dark:border-primary-200 hover:border-transparent rounded-full">
      Load all posts
    </a>
</div>
</section>
