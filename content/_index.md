  ...
  <div class="max-w-[85rem] px-6 py-6 text-center md:px-12">
    <div class="mx-auto">
      <div class="grid items-center gap-12 lg:grid-cols-2 mb-20">
        ...
        <div class="mt-8">
           <img class="rounded-full shadow-lx" width="466" height="293" loading="lazy" alt="" src="123.webp" />
        </div>
      </div>
    </div>
  </div>
...
<div class="max-w-[85rem] px-4 mb-10 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-2xl lg:max-w-5xl mx-auto">
    <div class="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
      <!-- Card -->
      <div class="flex flex-col border rounded-xl p-4 sm:p-10 lg:p-8 mb-6 border-neutral-200 dark:border-neutral-700 shadow-2xl">
