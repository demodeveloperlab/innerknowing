...
<div class="max-w-6xl mx-auto grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
  ...
  <div class="md:mb-0 bg-neutral dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 py-6 px-6 shadow-2xl text-center">
    <div class="flex justify-center items-center">
  ...
  <div class="relative mt-20 w-screen max-w-[1600px] px-[30px] bg-primary-200 dark:bg-neutral-900 pt-16 pb-2 rounded-xl dark:text-neutral-50" style="left: calc(max(-50vw,-800px) + 50%);">
    <div class="max-w-6xl mx-auto text-center mb-10 lg:mb-14">
      <div class="mx-auto text-center mb-10 lg:mb-14">
        ...
        <!-- Contact Us -->
<div class="max-w-[85rem] bg-neutral dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 py-6 px-6 shadow-2xl">
  <div class="max-w-2xl lg:max-w-5xl mx-auto">
    <div class="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
      <!-- Card -->
      <div class="flex flex-col border rounded-xl p-4 mb-6 border-neutral-200 dark:border-neutral-700">
